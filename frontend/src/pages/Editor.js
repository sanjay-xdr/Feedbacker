 ...
 const generateFeedbackForm=()=>{
  ...
  <div className="mt-1 flex items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
    <div className="space-y-1 text-center">
      ...
      <p className="text-xs text-gray-500">PNG, JPG and JPEG up to 5MB</p>
    </div>
  </div>
</div>
            ...
            <div className="w-1/2 flex items-center mb-4 mt-4">
              ...
              <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Collect User Email</label>
            </div>

            <div className="w-1/2 flex items-center mb-4 mt-4">
             
             <input id="default-checkbox" type="checkbox" value="" class=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
             <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Add Rating</label>
           </div>
       ...
       <div>
        ...
        <div className="w-1/2  p-4 flex flex-col justify-center items-center">
          ...
          kya logo ko form ka part bnaye ya fir aise hi jb user upload kre tbhi upload kr ke save kr le 
        </div>
